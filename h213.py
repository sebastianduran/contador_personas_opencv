...
while True:
	...
	cv2.rectangle(frame, (hab213TLx, hab213TLy), (hab213BRx, hab213BRy), (0, 255, 255), 2)	
	...
	for (objectID, centroid) in objects.items():
		...
		# to determine direction
			...
			if not to.counted:
				...
				if directionX < 0 and centroid[0] > hab213TLx and centroid[0] < hab213BRx:
					countCap[19] += 1
					to.counted = True

				# Se coloca por fuera los limites del eje x el centroid
				# Tambien se puede realizar un condicional con la dirección
				elif directionX > 0 and centroid[0] > hab213TLx and centroid[0] < hab213BRx :
					countCap[19] -= 1
					to.counted = True
	...
	info = [
        ...
        if countC01 != aux01:
                firebase.put('/habitacion/', '2-' + 13, countC01)
